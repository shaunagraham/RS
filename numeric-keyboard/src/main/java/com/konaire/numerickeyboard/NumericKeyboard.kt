...
class NumericKeyboard : FrameLayout {
    ...
    private fun updateView(layout: View) {
        ...
        val lv1 = layout.findViewById<View>(R.id.lvOne)
        val lv2 = layout.findViewById<LinearLayout>(R.id.lvTwo)
        val lv3 = layout.findViewById<View>(R.id.lvThree)
        val lv4 = layout.findViewById<View>(R.id.lvFour)
        val lv5 = layout.findViewById<LinearLayout>(R.id.lvFive)
        val lv6 = layout.findViewById<View>(R.id.lvSix)
        val lv7 = layout.findViewById<View>(R.id.lvSeven)
        val lv8 = layout.findViewById<LinearLayout>(R.id.lvEight)
        val lv9 = layout.findViewById<View>(R.id.lvNine)
        ...
        lv1.setOnClickListener(listener)
        lv2.setOnClickListener(listener)
        lv3.setOnClickListener(listener)
        lv4.setOnClickListener(listener)
        lv5.setOnClickListener(listener)
        lv6.setOnClickListener(listener)
        lv7.setOnClickListener(listener)
        lv8.setOnClickListener(listener)
        lv9.setOnClickListener(listener)
